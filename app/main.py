...
def configure_retriever(path):
    ...
    # see env at https://boto3.amazonaws.com/v1/documentation/api/latest/guide/credentials.html
    # see params at https://github.com/langchain-ai/langchain/blob/b786335dd10902489f87a536ee074d747b6df370/libs/langchain/langchain/embeddings/bedrock.py
    # see Embedding models available - https://us-east-1.console.aws.amazon.com/bedrock/home?region=us-east-1#/modelaccess
    embeddings = BedrockEmbeddings(
        credentials_profile_name="bedrock-demo",
